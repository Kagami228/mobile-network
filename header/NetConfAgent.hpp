    ...
    public:
        ...
        bool subscribeForModelChanges(std::string _module_name)
        {
            ...
            try 
            {
                auto cb = [] (sysrepo::S_Session Session, const char *module_name, const char *xpath, sr_event_t event,
                    ...
                    try 
                    {
                        std::cout << " Notification " << ev_to_str(event) <<std::endl;
        ...
        bool registerOperData(std::string _module_name)
        {
            ...
            try {
                ...
                std::cout << "OperData changed" <<std::endl;
